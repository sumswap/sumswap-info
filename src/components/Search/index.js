...
import { useAllPairsInSumswap, useAllTokensInSumswap } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInSumswap()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInSumswap()
              ...
              : below410
                ...
                : below470
                  ...
                  : below700
                    ...
                    : 'Search Sumswap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
